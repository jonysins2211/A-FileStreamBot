...
class Telegram:
    ...
    MULTI_CLIENT = True
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", "-1002710313786"))   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", "-1002710313786"))   # Logs channel for user logs
